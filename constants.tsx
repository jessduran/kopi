...
export const Icons = {
  ...
  Feather: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="mx-auto text-[#3e2723]/20"><path d="m10 14 8-8"/><path d="M11 15.5c.5.5 1.5.5 2 0l7-7c.5-.5.5-1.5 0-2s-1.5-.5-2 0l-7 7c-.5.5-.5 1.5 0 2Z"/><path d="m14 13 4 4.2c.8.8.8 2.1 0 2.9l-.1.1c-.8.8-2.1.8-2.9 0L11 16"/><path d="m3 21 3-3"/><path d="M8.5 20c.3-1.7 1.5-3 3-3.3"/></svg>
  )
};
